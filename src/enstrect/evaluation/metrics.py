...
from utils3d.conversion.lines import interpolate_G

def G_to_lineIoU3d(G_true, G_pred, gap=0.01, tol=0.01):
    ...
    clcloudiou = lineIoU3d(true_pos, pred_pos, tol=tol)
    return clcloudiou

def lineIoU3d(true_pos, pred_pos, tol=0.1):
    if len(pred_pos) == 0:
