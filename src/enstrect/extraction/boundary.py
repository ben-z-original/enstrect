...
def extract_bounding_polygons(pcd_pynt, category="corrosion", min_count=2000):
    ...
    relevant_clusters = [key for (key, value) in cluster_classes.items() if value == category]
